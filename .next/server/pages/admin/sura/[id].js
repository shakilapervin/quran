...
function Edit({ user , id  }) {
    const { 0: sura , 1: setSura  } = (0,react__WEBPACK_IMPORTED_MODULE_7__.useState)();
...
var __webpack_exports__ = __webpack_require__.X(0, [311,675,952,664,531,652], () => (__webpack_exec__(6358)));
